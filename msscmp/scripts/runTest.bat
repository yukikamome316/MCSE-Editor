...
if "%fastmode%"=="1" (
    ...
    tcc %compileOpt% ../msscmp/res/resource.c ../msscmp/res/res.c ../msscmp/log.c ../msscmp/msscmp.c -run ../msscmp/test.c %msscmpPath%
) else (
    rem Builded dll option
    if "%buildeddll%"=="0" (
        call ..\msscmp\scripts\build_msscmp.bat %compileOpt%
        move ..\msscmp\msscmp.dll ./
    )
    echo [-]compile test
    tcc %compileOpt% msscmp.dll ../msscmp/test.c -o test.exe
    echo [-]run test
    test.exe %msscmpPath%
)
